...
var uncheckTick = keyframes(["to{stroke-dashoffset:20px;}"]);
var Container = styled.div(_templateObject());
var TickIcon = styled(CheckIcon)(_templateObject2(), uncheckTick);
var CheckboxContainer = styled.div(_templateObject3(), getColor('grey80'), getColor('grey20'), function (props) {
  return props.checked && css(["background-color:", ";border-color:", ";", "{animation-delay:0.2s;animation:", " 0.2s ease-out forwards;stroke-dashoffset:20px;opacity:1;transition-delay:0s;}"], getColor('blue100'), getColor('blue100'), TickIcon, checkTick);
}, function (props) {
...
var LabelContainer = styled.div(_templateObject4(), getColor('grey140'), function (props) {
...
var Checkbox = function Checkbox(_ref) {
  var label = _ref.label,
      ...
      _ref$undetermined = _ref.undetermined,
      undetermined = _ref$undetermined === void 0 ? false : _ref$undetermined,
  ...
  var handleChange = function handleChange() {
    return onChange && !readOnly && onChange(!checked);
  };
  ...
  return /*#__PURE__*/react.createElement(Container, {
    ...
    readOnly: readOnly
  }, undetermined ? /*#__PURE__*/react.createElement(PartialCheckIcon, {
    height: 20,
    width: 20
  }) : /*#__PURE__*/react.createElement(TickIcon, {
    height: 20,
    width: 20
  })), label ? /*#__PURE__*/react.createElement(LabelContainer, {
    readOnly: readOnly
  }, label) : null);
};
...
var DummyContainer = styled.div(_templateObject$1(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
export { CheckIcon, Checkbox, Dummy, PartialCheckIcon };
