...
var CheckboxContainer = styled.div(_templateObject3(), getColor('grey80'), getColor('grey20'), function (props) {
  return props.checked && css(["background-color:", ";", "{animation-delay:0.2s;animation:", " 0.2s ease-out forwards;stroke-dashoffset:20px;opacity:1;transition-delay:0s;}"], getColor('blue100'), TickIcon, checkTick);
}, function (props) {
